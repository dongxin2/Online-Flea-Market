...
//	}
	...
	function login() {
        ...
        let use_id = sessionStorage.getItem('user_id');
...
//		// make AJAX call
		...
		function(res) {
			...
			if (!username || username.length === 0) {
				// step 14
				showWarningMessage('User ID Not Found.');
			} else {
				// step 16
				console.log("found user");
				console.log(username.fullname);
				sessionStorage.setItem('name', username.fullname);
			}
		...
		function() {
			// step 15
			showErrorMessage('Cannot Find User.');
		});
	}
